...
To speed up computations one typically reduces the search depth of the algorithm. This means that for each subproblem the search for \(k,l\) is limited ot to \(|k-i|<h\) and \(|l-j| < h \), where \(h\) is the depth.  
