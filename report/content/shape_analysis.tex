...
%One can also note that by the Quotient Manifold Theorem [0], the shape space is also a smooth manifold with the quotient map being a smooth submersion. What is a smooth submersion.
%  double check  
